...
class eval_callback(tf.keras.callbacks.Callback):
    ...
    def __do_predict__(self):
        ...
        for img_batch in tqdm(self.ds, "Evaluating " + self.test_names, total=self.steps):
            ...
            interpreter.set_tensor(input_details[0]['index'], tf.image.resize(img_batch[...,::-1],[160,160]))
            interpreter.invoke()
            ...
            if self.flip:  
                ...
                interpreter.set_tensor(input_details[0]['index'],tf.image.flip_left_right(tf.image.resize(img_batch[...,::-1],[160,160])))
                interpreter.invoke()
...
def evaluate(embeddings, actual_issame, nrof_folds=10, pca=0):
            ...
            #Evaluating the modelby fixing the FAR to 1e-3
